...
<head>
	...
	<link href="<%=request.getContextPath()%><pwm:url url='/public/resources/bootstrap2/css/bootstrap.css' />" rel="stylesheet" type="text/css" media="screen"/>
	<link href="<%=request.getContextPath()%><pwm:url url='/public/resources/bootstrap2/css/bootstrap-responsive.css' />" rel="stylesheet" type="text/css" media="screen"/>
	...
	<script src="<%=request.getContextPath()%><pwm:url url='/public/resources/js/jquery-1.11.2.min.js'/>"></script>
    <script defer type="text/javascript" src="<%=request.getContextPath()%><pwm:url url='/public/resources/js/main.js'/>"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%><pwm:url url='/public/resources/bootstrap2/js/bootstrap.js' />"></script>
	</head>
